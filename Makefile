...
X64_OUT   = $(patsubst %,build/x86_64/%.exe,$(TOOLS)) build/x86_64/Rescue.exe
ARM64_OUT = $(patsubst %,build/arm64/%.exe,$(TOOLS)) build/arm64/Rescue.exe
...
build/x86_64/Rescue.exe: src/rescue_gui.cpp src/rescue_gui.rc src/rescue.manifest
...
build/arm64/Rescue.exe: src/rescue_gui.cpp src/rescue_gui.rc src/rescue.manifest
	@mkdir -p build/arm64
